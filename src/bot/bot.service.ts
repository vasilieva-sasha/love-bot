...
export class BotService {
  ...
  async handleStart(ctx: Context) {
    const text = `Привет! 👋
Это бот для пар, который помогает обмениваться заказами и посланиями.

Что можно делать:
• Создавать и редактировать своё меню (массаж, завтрак и т.д.)
• Отправлять заказы партнёру с валютой: поцелуй, обнимашка или послание
• Указывать срок выполнения и отмечать, когда заказ готов
• Просто отправлять милые послания без заказа

Начнём с создания твоего меню!`;
